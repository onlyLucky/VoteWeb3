      ...
      <view w-[100%] h-[100%] overflow-auto>
        ...
        <view w-[100%] h-440rpx bg-[#fff] mb-32rpx>
          ...
          <live-player
            w-[100%]
            h-440rpx
            src="rtmp://test.chinapaperless.com:1936/live/livestream1106"
            mode="RTC"
            autoplay
        ...
        <view flex items-center mb-16rpx>
          <image w-36rpx h-36rpx mr-6rpx src="@img/icons/icon_ctrl_device.png" mode="scaleToFill" />
        ...
        <!-- 遥控器 -->
        <view w-[100%] flex items-center justify-center>
          <view w-480rpx h-480rpx border-rd-[100%] relative mt-96rpx rotate="45" class="clicker">
            <view
              w-440rpx
              h-440rpx
              border-rd-[100%]
...
<style scoped lang="scss">
  .ctrlPage {
    .clicker {
      ...
      .clickerCon {
        box-shadow:
          18px 18px 30px 0px rgba(209, 217, 230, 0.9),
          -18px 18px 30px 0px rgba(209, 217, 230, 0.2),
          inset -1px -1px 2px 0px rgba(209, 217, 230, 0.5),
        ...
        .cenCtrl {
          background: #ecf0f3;
          box-shadow:
            inset 5px 5px 13px 0px rgba(209, 217, 230, 0.9),
            inset -5px -5px 10px 0px rgba(255, 255, 255, 0.9),
            inset 5px -5px 10px 0px rgba(209, 217, 230, 0.2),
